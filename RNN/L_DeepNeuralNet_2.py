...
m_train =500# max 49 999
m_test=	200	#max 9 999
mini_batch_size =8
num_pix=32
...
keepProbs = [1,0.7,1]  # dropOut regularisation, one value for each layer (prob of deleting a neuron)
...
#verifier données d'entré  OK
#si grad exploding ou vanishing
# chercher bug au niveau de la cost function
# pas mettre de batch pour l'instant
#cherche au nivreau de l'initialisation des poids
#chercher bugs dans approx gradient
